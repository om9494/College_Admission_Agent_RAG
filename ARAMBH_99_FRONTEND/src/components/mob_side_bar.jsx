...
export default function MobSideBar() {
  ...
  return (
    <div>
      ...
      <div id="sidebar" className="msidebar bar w-72 p-6 pt-10 h-screen fixed top-0 left-0 overflow-y-scroll scroll-smooth ">
        ...
        <button className='mb-4 w-full rounded-3xl' onClick={handleDownloadChat}>{translate("Download Chat")}</button>
        <hr></hr>
        <div id="features" className="features space-y-4">
        ...
        <br /><br />
        <center>
          <div id="mopt-holder-side" className="opt-holder-side">
