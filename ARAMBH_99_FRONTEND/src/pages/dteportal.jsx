...
export default function DtePortal() {
    ...
    const loadCollegeData = async () => {
      ...
      try {
        ...
        if (storedCollege) {
          ...
          alert("No college Selected! in Dashboard");
          navigate("/dte/dashboard");
        }
      } catch (err) {
  ...
  return (
    <>
      ...
      <div className='display-college'>
        <div className=" bg-white rounded-lg ml-auto mr-auto mt-10 max-w-5xl p-20">
          <form name="College Data" onSubmit={handleUpdate}>
            <div className="space-y-4">
              ...
              <div className="text-center absolute top-28 right-20">
                ...
                <Link to="/dte/dashboard" className="mt-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 ml-5">Cancel</Link>
              </div>
